  ...
  return (
    <div className="mt-10" style={{ margin: '100px 150px' }}>
      <div className="flex justify-between items-center mb-10 gap-20" style={{ margin: '80px 0' }}>
        <h1 className="text-4xl font-bold" style={{ color: '#261B6C', marginTop: '-200px' }}>About Baker&apos;s Inn</h1>
        <div className="text-left" style={{ flexBasis: '60%', color: '#261B6C', marginLeft: '-50px' }}>
          <p className="text-2xl mb-4">It all started in the eighties when Baker&apos;s Inn was just a small confectionery company that employed 40 people and produced about 30,000 loaves a day. We now aim to provide a nourishing, convenient and accessible answer to hunger&apos;s call.</p>
      ...
      <div className="grid grid-cols-4 gap-16">
        <div className="bg-white rounded-lg shadow-md overflow-hidden relative h-[200px]">
