...
const ProductRange = () => {
  return (
    <div className="mt-10 text-center" style={{ padding:'100px 150px 50px 150px ',margin: '0px' ,backgroundColor: 'whitesmoke'  }}>
      ...
      <button className="bg-[#a17c48] font-bold text-white border-none  cursor-pointer rounded text-[20px] py-[10px] px-[50px]">
        VIEW COMPLETE RANGE
      </button>
    </div>
  );
